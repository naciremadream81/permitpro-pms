    ...
    <AppLayout>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <h1 className="text-2xl font-extrabold uppercase tracking-tight text-ink">New Customer</h1>
          <Link href="/customers">
        ...
        <Card>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label htmlFor="contactName" className="block text-sm font-medium text-ink mb-1">
                  Contact Name
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="mainAddress" className="block text-sm font-medium text-ink mb-1">
                  Main Address
                </label>
                <input
                  type="text"
