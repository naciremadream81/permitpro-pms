    ...
    <AppLayout>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <h1 className="text-2xl font-extrabold uppercase tracking-tight text-ink">New Contractor</h1>
        ...
        <Card>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label htmlFor="companyName" className="block text-sm font-medium text-ink mb-1">
                  Company Name *
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="licenseNumber" className="block text-sm font-medium text-ink mb-1">
                  License Number
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="preferredContactMethod" className="block text-sm font-medium text-ink mb-1">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                  {availableSpecialties.map((specialty) => (
                    ...
                    >
                      ...
                      />
                      <span className="text-sm text-ink">{specialty}</span>
                    </label>
                  ))}
                </div>
                <div className="mt-3">
                  <label htmlFor="otherSpecialty" className="block text-sm font-medium text-ink mb-1">
                    Other Specialty
                  </label>
                  <input
                    type="text"
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div>
                  <label htmlFor="workersCompExpirationDate" className="block text-sm font-medium text-ink mb-1">
                ...
                <div>
                  <label htmlFor="liabilityExpirationDate" className="block text-sm font-medium text-ink mb-1">
