      ...
      <div className="bg-gray-900 text-white">
        <div className="max-w-7xl mx-auto px-6 pt-4 pb-6">
          ...
          <nav className="flex items-center gap-1.5 text-xs text-gray-400 mb-4">
            ...
            <span className="text-white">Counties</span>
          </nav>
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="relative w-full sm:w-72">
            ...
            <input
              ...
              className="w-full rounded-lg border border-gray-200 bg-white pl-9 pr-3 py-2 text-sm text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            />
          </div>
