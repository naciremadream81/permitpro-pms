    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent>
          {/* Add/Edit User Form */}
          {showUserForm && (
            <form onSubmit={handleSubmit} className="mb-6 p-4 border rounded-md bg-surface-inset">
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b">
                  <th className="px-4 py-2 text-left text-sm font-medium text-ink">Name</th>
                  <th className="px-4 py-2 text-left text-sm font-medium text-ink">Email</th>
                  <th className="px-4 py-2 text-left text-sm font-medium text-ink">Role</th>
                  <th className="px-4 py-2 text-left text-sm font-medium text-ink">Activity</th>
                  <th className="px-4 py-2 text-left text-sm font-medium text-ink">Created</th>
                  <th className="px-4 py-2 text-left text-sm font-medium text-ink">Actions</th>
                </tr>
              </thead>
              <tbody>
                {users.map((user) => (
                  <tr key={user.id} className="border-b hover:bg-surface-inset">
